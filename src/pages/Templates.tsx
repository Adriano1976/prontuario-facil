...
const estadoInicial = (): TemplateFormState => ({
    name: '',
...
export default function Templates() {
    ...
    const [formData, setFormData] = useState<TemplateFormState>(estadoInicial);
    ...
    const deleteMutation = useMutation({
        mutationFn: (id: string) => base44.entities.Template.delete(id),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['templates'] });
    ...
    const groupedTemplates = templates?.reduce((acc: Record<string, Template[]>, t) => {
                ...
                <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <Label>Tipo *</Label>
                                <Select value={formData.type} onValueChange={(v) => setFormData({ ...formData, type: v as TemplateType })}>
                                    <SelectTrigger>
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
