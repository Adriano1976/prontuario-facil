...
interface LayoutProps {
    /** Conteúdo da página a renderizar na área principal. */
    children: ReactNode;
    /** Nome da página atual para destacar na navegação. */
    ...
    const handleDeleteAccount = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: message || "Não foi possível excluir a conta. Tente novamente.",
            });
        }
    };
