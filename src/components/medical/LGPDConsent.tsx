...
/**
 * Diálogo do termo de consentimento de proteção de dados.
 *
 * PARIDADE: comportamento e textos idênticos ao componente anterior. Continuam iguais:
 * o aceite só habilita o botão, o botão só dispara o aceite se a caixa estiver marcada,
 * e ao aceitar o diálogo se fecha.
 *
 * Nota: o componente apenas coleta o aceite. Gravar a data e o endereço de rede do
 * consentimento é responsabilidade de quem salva o cadastro (BR-MIGRAR-004).
 */
...
interface LGPDConsentProps {
  ...
  /** Chamado quando o termo é aceito. */
  onAccept: () => void;
}

export default function LGPDConsent({ open, onOpenChange, onAccept }: LGPDConsentProps) {
        ...
        <ScrollArea className="h-[400px] pr-4">
          <div className="space-y-4 text-sm text-slate-600">
            <section>
              ...
              <p>
                A clínica médica, na qualidade de controladora de dados pessoais,
                compromete-se a proteger os dados pessoais coletados de seus pacientes, em
            ...
            <section>
              ...
              <p>
                Os dados serão armazenados em ambiente seguro, com criptografia e controle
                de acesso, pelo prazo mínimo de 20 anos conforme resolução CFM nº
                1.821/2007, ou pelo prazo necessário ao cumprimento de obrigações legais.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Ao aceitar este termo, o paciente declara que leu, compreendeu e concorda
                com o tratamento de seus dados pessoais conforme descrito acima.
              </p>
            </section>
          </div>
        </ScrollArea>
        ...
        <div className="border-t pt-4">
          <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl">
            ...
            <label htmlFor="consent" className="text-sm text-slate-700 cursor-pointer">
              Declaro que li e compreendi o Termo de Consentimento para Tratamento de Dados
              Pessoais acima e <strong>AUTORIZO</strong> a coleta, uso, armazenamento e
              compartilhamento dos meus dados pessoais e de saúde conforme descrito.
            </label>
          </div>
        </div>
