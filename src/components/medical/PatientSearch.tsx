...
/**
 * Busca de pacientes por nome, CPF ou telefone, com resultados em lista suspensa.
 *
 * PARIDADE: comportamento idêntico ao componente anterior. Continuam iguais: o mínimo
 * de 2 caracteres para buscar, o limite de 5 resultados, a busca em nome, CPF e
 * telefone, o atraso de 200 ms ao perder o foco (para o clique no resultado registrar)
 * e os rótulos de situação ativo/inativo.
 *
 * Nota: o CPF aparece aqui como dado de busca. Ele é dado sensível no servidor; o
 * componente apenas compara o que recebe, sem exibir.
 */

interface PatientSearchProps {
  /** Pacientes disponíveis para busca. */
  patients?: Patient[];
  /** Indica carregamento em andamento. */
  isLoading?: boolean;
}

export default function PatientSearch({ patients, isLoading }: PatientSearchProps) {
